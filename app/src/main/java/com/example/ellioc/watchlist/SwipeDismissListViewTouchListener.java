...
public class SwipeDismissListViewTouchListener implements View.OnTouchListener {
    ...
    /** I added this to make tapping work too!!!! **/
//    private Context mContext;
//    private ArrayList<OmdbObject> mEntries;
...
//                    intent.putExtra("omdb_object_key", mEntries.get(mListView.getPositionForView(view)).getMovieId());
