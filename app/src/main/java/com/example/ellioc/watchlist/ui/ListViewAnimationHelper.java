package com.example.ellioc.watchlist.ui;

/**
 * Created by Ellioc on 9/5/2016.
 */
...
public class ListViewAnimationHelper {
    ...
    BaseAdapter adapter;
    ListView listView;
    ArrayList<OmdbObject> dataSource;
...
// ================================================================================
    ...
    public ListViewAnimationHelper(BaseAdapter adapter, ListView listView, ArrayList<OmdbObject>dataSource) {
